...
from .serializers import ComplaintDetailSerializer, CreateComplaintSerializer, DispatcherNewTicketSerializer, LiaisonInboxSerializer, TicketHistoryTimelineSerializer, VerifyComplaintSerializer,MergeTicketsSerializer,SendUpdateSerializer, EvaluateComplaintSerializer,Tier1NewTicketSerializer,ComplaintListSerializer
import random
     ...
     def post(self, request, *args, **kwargs):
        ...
        with transaction.atomic():
            ...
            for ticket in tickets_to_merge:
                ...
                ticket.status = Complaint.Status.CLOSED 
                ticket.merged_to = primary_ticket       
