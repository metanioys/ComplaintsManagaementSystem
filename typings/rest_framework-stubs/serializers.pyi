...
class BaseSerializer(Field):
    ...
    @property
    def validated_data(self): # -> empty | dict | None:
        ...
...
def as_serializer_error(exc): # -> dict[Any, ReturnList | ReturnDict | dict[Any, ReturnList | ReturnDict | ErrorDetail] | list[ErrorDetail] | list | Mapping | list[ErrorDetail | Any]] | dict[Any | list[Any] | None, list[ErrorDetail] | ReturnList | list[ReturnList | ReturnDict | dict[Any, ReturnList | ReturnDict | dict[Any, ReturnList | ReturnDict | ErrorDetail] | ErrorDetail] | ErrorDetail]] | dict[Any | list[Any] | None, list[ErrorDetail]]:
    """
...
class Serializer(BaseSerializer, metaclass=SerializerMetaclass):
    ...
    def run_validation(self, data=...): # -> empty | dict | None:
        """
...
class ListSerializer(BaseSerializer):
    ...
    def get_value(self, dictionary): # -> list | type[empty]:
        """
        Given the input dictionary, return the field value.
        """
        ...
    
    def run_validation(self, data=...): # -> empty | list | None:
        """
        We override the default `run_validation`, because the validation
        performed by validators and the `.validate()` method should
        be coerced into an error dictionary with a 'non_fields_error' key.
...
class ModelSerializer(Serializer):
    ...
    * Default `.create()` and `.update()` implementations are provided.
    ...
    def get_field_names(self, declared_fields, info): # -> Any | list | tuple:
        """
    ...
    def get_default_field_names(self, declared_fields, model_info): # -> list:
        """
    ...
    def build_field(self, field_name, info, model_class, nested_depth): # -> tuple[type[PrimaryKeyRelatedField] | Any | type[ModelField] | type[CharField] | type[ChoiceField], Any] | tuple[type[SlugRelatedField] | type[PrimaryKeyRelatedField] | type[<subclass of SlugRelatedField and HyperlinkedRelatedField>] | type[<subclass of PrimaryKeyRelatedField and HyperlinkedRelatedField>], dict[str, Any]] | tuple[type[NestedSerializer], dict[str, bool]] | tuple[type[ReadOnlyField], dict] | tuple[serializer_url_field, dict[str, str]]:
        """
    ...
    def build_property_field(self, field_name, model_class): # -> tuple[type[ReadOnlyField], dict]:
        """
    ...
    def get_unique_together_constraints(self, model): # -> Generator[tuple[Any, Any, list, None] | tuple[Sequence[str], Any, list[str | Any], Q | None], Any, None]:
        """
    ...
    def get_uniqueness_extra_kwargs(self, field_names, declared_fields, extra_kwargs): # -> tuple[Any, dict]:
        """
    ...
    def get_validators(self): # -> list[Any] | list:
        """
    ...
    def get_unique_for_date_validators(self): # -> list:
        """
